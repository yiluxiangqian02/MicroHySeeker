...
class ProgramEditorDialog(QDialog):
    ...
    def _create_transfer_panel(self) -> QWidget:
        ...
        self.tf_duration_spin.setSingleStep(0.01)
    ...
    def _create_prep_sol_panel(self) -> QWidget:
        ...
        self.ps_vol_spin.setSingleStep(0.01)
    ...
    def _create_flush_panel(self) -> QWidget:
        ...
        # 仅排空开关 - 顶部醒目位置
        self.fl_evacuate_only = QCheckBox("仅排空溶液，不注水冲洗")
        self.fl_evacuate_only.setChecked(False)
        self.fl_evacuate_only.setStyleSheet("color: #F44336; font-weight: bold;")
        self.fl_evacuate_only.stateChanged.connect(self._on_evacuate_only_changed)
        layout.addRow("", self.fl_evacuate_only)
        ...
        self.fl_duration_spin.setSingleStep(0.01)
        self.fl_duration_spin.setValue(30.00)
        self.fl_duration_label = QLabel("循环时长(s):")
        layout.addRow(self.fl_duration_label, self.fl_duration_spin)
    ...
    def _on_evacuate_only_changed(self, state):
        """当仅排空选项改变时，调整标签文字"""
        if state:
            self.fl_duration_label.setText("排空时长(s):")
        else:
            self.fl_duration_label.setText("循环时长(s):")
    ...
    def _create_echem_panel(self) -> QWidget:
        ...
        self.ec_e0_spin.setSingleStep(0.01)
        ...
        self.ec_eh_spin.setSingleStep(0.01)
        ...
        self.ec_el_spin.setSingleStep(0.01)
        ...
        self.ec_ef_spin.setSingleStep(0.01)
        ...
        self.ec_scanrate_spin.setRange(0.01, 10)
        self.ec_scanrate_spin.setDecimals(2)
        self.ec_scanrate_spin.setSingleStep(0.01)
        ...
        self.ec_sensitivity_spin.setRange(0.01, 100)
        self.ec_sensitivity_spin.setDecimals(2)
        self.ec_sensitivity_spin.setSingleStep(0.01)
        ...
        self.ec_interval_spin.setSingleStep(0.01)
        ...
        self.ec_quiettime_spin.setSingleStep(0.01)
        ...
        self.ec_runtime_spin.setSingleStep(0.01)
        ...
        self.ec_ocpt_threshold.setSingleStep(0.01)
        ...
        self.ec_ocpt_duration.setSingleStep(0.01)
    ...
    def _create_blank_panel(self) -> QWidget:
        ...
        self.bl_duration_spin.setSingleStep(0.01)
    ...
    def _load_step_to_ui(self):
        ...
        # 如果是旧的排空类型，转换为冲洗+仅排空
        if step.step_type == ProgramStepType.EVACUATE:
            type_index = 2  # FLUSH index
        ...
        if step.step_type == ProgramStepType.TRANSFER:
            ...
            # 旧的排空类型转为冲洗+仅排空
            self._load_flush(step)
            self.fl_evacuate_only.setChecked(True)
    ...
    def _load_flush(self, step: ProgStep):
        ...
        # 加载仅排空状态
        evacuate_only = getattr(step, 'evacuate_only', False)
        self.fl_evacuate_only.setChecked(evacuate_only)
    ...
    # _load_evacuate 已删除 - 排空功能合并到冲洗模块
    ...
    def _save_current_step(self):
        ...
        if step.step_type == ProgramStepType.TRANSFER:
            ...
            step.evacuate_only = self.fl_evacuate_only.isChecked()  # 仅排空标志
        ...
        # EVACUATE 已合并到 FLUSH - 不再有单独的保存逻辑
