...
_EXPORTS = {
    ...
    "HeartbeatInspectorSkill": "src.skills.heartbeat_inspector_skill",
    "heartbeat_inspector_skill": "src.skills.heartbeat_inspector_skill",
    ...
    "RealtimeMonitorSkill": "src.skills.realtime_monitor_skill",
    "SmartSchedulerSkill": "src.skills.experiment_execution",
    "execution_monitor_skill": "src.skills.experiment_execution",
    "realtime_monitor_skill": "src.skills.realtime_monitor_skill",
    ...
    "KnowledgeQuerySkill": "src.skills.knowledge_query_skill",
    "knowledge_query_skill": "src.skills.knowledge_query_skill",
